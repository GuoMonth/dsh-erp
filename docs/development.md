...
```sh
dsh plugin --profile headless add /absolute/path/dsh-erp-0.1.0-alpha.2.tgz
...
```sh
npm exec --yes --package=pnpm@11.7.0 -- dsh plugin --profile headless add /absolute/path/dsh-erp-0.1.0-alpha.2.tgz
```
